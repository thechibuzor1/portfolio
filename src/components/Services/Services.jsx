          ...
          <article className="service">
            ...
            <ul className="service__list">
              <li>
                ...
                <p>
                  Handle projects independently and successfully in challenging
              ...
              <li>
                <BiCheck className="service__list-icon" />
                <p>
                  Experience developing high quality code, and being accountable
                  for technical delivery of projects to specifications within
                  the given timelines.
                </p>
              </li>
              <li>
                <BiCheck className="service__list-icon" />
                <p>
                  Experience in building e-commerce and enterprise software
                  solutions.
                </p>
              </li>
              <li>
          ...
          <article className="service">
            ...
            <ul className="service__list">
              ...
              <li>
                <BiCheck className="service__list-icon" />
                <p>
                  Developed authentication procedure to MongoDB, Firebase and
                  Rest API.
                </p>
              </li>
              <li>
              ...
              <li>
                <BiCheck className="service__list-icon" />
                <p>
                  Understand client's needs to build apps in stipulated
                  time/budget.
                </p>
              </li>
              <li>
                <BiCheck className="service__list-icon" />
                <p>
                  Maintain code and write automated tests to ensure the product
